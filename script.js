...
function tampilSoal(){
    ...
    document.getElementById("infoSkor").textContent = `Soal: ${i+1} / ${totalSoal} | Benar: ${benar} | Salah: ${salah}`;
}
...
function cekJawaban(btn){
    ...
    document.getElementById("infoSkor").textContent = `Soal: ${i} / ${totalSoal} | Benar: ${benar} | Salah: ${salah}`;
    if(i>=totalSoal){
